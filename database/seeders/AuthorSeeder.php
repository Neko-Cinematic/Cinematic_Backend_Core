...
class AuthorSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('authors')->insert([
            ...
            ['name' => 'Chris Evans', 'id_images' => '10', 'created_at' => $date, 'updated_at' => $date],
            ['name' => 'Dwayne Johnson', 'id_images' => '11', 'created_at' => $date, 'updated_at' => $date],
            ['name' => 'Gal Gadot', 'id_images' => '12', 'created_at' => $date, 'updated_at' => $date],
            ['name' => 'Ryan Reynolds', 'id_images' => '13', 'created_at' => $date, 'updated_at' => $date],
            ['name' => 'Jennifer Lawrence', 'id_images' => '14', 'created_at' => $date, 'updated_at' => $date],
        ]);
    }
}
